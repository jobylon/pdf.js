...
{
  const HOSTED_VIEWER_ORIGINS = new Set(["http://jobylon.github.io", "https://jobylon.github.io"]);
...
const pdfjsVersion = "5.3.11";
const pdfjsBuild = "fc68a9f3e";
const AppConstants = {
